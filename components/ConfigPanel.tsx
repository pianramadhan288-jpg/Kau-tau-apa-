...
import { Shield, ShieldAlert, ShieldCheck, Zap, Wallet, Lock, Save, User, MessageSquare, Briefcase } from 'lucide-react';
            ...
            <div className="grid gap-8">
                ...
                <div className="bg-[#111] border border-[#222] rounded-3xl p-8">
                    <div className="flex items-center gap-3 mb-6 pb-6 border-b border-[#222]">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-white">Identity & Persona</h3>
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-[10px] font-bold text-slate-500 mb-2 uppercase tracking-widest">AI Persona (Tone)</label>
                                <div className="flex gap-2">
                                    <button 
                                        onClick={() => handleChange('persona', 'INSTITUTIONAL')}
                                        className={`flex-1 p-3 rounded-xl border text-xs font-bold flex items-center gap-2 justify-center transition-all ${localConfig.persona === 'INSTITUTIONAL' ? 'bg-white text-black border-white' : 'bg-[#1a1a1a] text-slate-400 border-[#333] hover:border-[#555]'}`}
                                    >
                                        <Briefcase size={14} /> Institusi
                                    </button>
                                    <button 
                                        onClick={() => handleChange('persona', 'RETAIL_SEMI_FORMAL')}
                                        className={`flex-1 p-3 rounded-xl border text-xs font-bold flex items-center gap-2 justify-center transition-all ${localConfig.persona === 'RETAIL_SEMI_FORMAL' ? 'bg-white text-black border-white' : 'bg-[#1a1a1a] text-slate-400 border-[#333] hover:border-[#555]'}`}
                                    >
